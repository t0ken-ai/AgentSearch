...
from cloak_stealth_suite.engines.ecosia import EcosiaEngine
...
def _attempt(engine: EcosiaEngine, attempt: int) -> list:
...
def main() -> int:
    ...
    print("=== Ecosia search adapter test ===")
    ...
    try:
        ...
        assert len(results) > 0, "expected at least one Ecosia result"
